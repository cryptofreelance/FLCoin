...
This mechanism has been integrated into Bitcore-Node-FLCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/flcoinproject/insight-api-flcoin#web-socket-api](https://github.com/flcoinproject/insight-api-flcoin#web-socket-api)
* API: [https://github.com/flcoinproject/insight-api-flcoin#instantsend-transactions](https://github.com/flcoinproject/insight-api-flcoin#instantsend-transactions)
...
By default, the FLCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FLCoin Core daemon:
