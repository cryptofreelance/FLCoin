...
FLCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 19001.
...
However, in open source software such as FLCoin Core, where everyone uses
...
pay attention to for reviewers of FLCoin Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: FLCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
