...
Only requiring some minor changes is flcoin.cpp.
...
Changes to flcoin.cpp
----------------------
flcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
