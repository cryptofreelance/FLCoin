...
#define BOOST_TEST_MODULE FLCoin Test Suite

#include "test_flcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_flcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
