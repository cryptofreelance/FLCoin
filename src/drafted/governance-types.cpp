...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FLCoinNetwork") type = FLCoinNetwork;
    if(strType == "FLCoinNetworkVariable") type = FLCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FLCoinNetwork) s = "FLCoinNetwork";
    if(type == FLCoinNetworkVariable) s = "FLCoinNetworkVariable";
