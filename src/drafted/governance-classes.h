 ...
 *
 *   // network
 *   CFLCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.flcoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFLCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: FLCoinNetwork
// //   -- signature requirements : Key1(User)
// class CFLCoinNetworkVariable : public CGovernanceObject
// {
// private:
