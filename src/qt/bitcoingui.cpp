    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FLCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FLCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and flcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FLCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about FLCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FLCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FLCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FLCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a flcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FLCoin Core help message to get a list with possible FLCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FLCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FLCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("FLCoin Core"); // default title
