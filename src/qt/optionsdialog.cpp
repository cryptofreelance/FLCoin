    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FLC-light"), QVariant("light"));
    ui->theme->addItem(QString("FLC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("FLC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FLC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FLC-traditional"), QVariant("trad"));
