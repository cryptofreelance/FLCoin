    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FLCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FLCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  flcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FLCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an innovative process to mix your inputs with the inputs of two other flcoin, without having your coins ever leave your wallet. \
...
These denominations are 0.01 FLC, 0.1 FLC, 1 FLC and 10 FLC -- sort of like the paper money you use every day.</li> \
...
<li>When two other flcoin send similar messages, indicating that they wish to mix the same denomination, a mixing session begins. \
...
For more info see <a href=\"https://FLCoinDev.atlassian.net/wiki/display/DOC/PrivateSend\">https://FLCoinDev.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FLCoin Core is shutting down...") + "<br /><br />" +
