...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all FLCoin related functionality
...
/*
    ...
    allow endless transaction that would bloat FLCoin and make it unusable. To
